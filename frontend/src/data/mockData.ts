...
export const stats = [
  { label: "Total Revenue Today", value: "$1,247.50", trend: "↑ 12.5%", accent: "text-emerald-600" },
  { label: "Total Orders Today",  value: "87",        trend: "↑ 8.2%",  accent: "text-emerald-600" },
  { label: "Low Stock Items",     value: "4",         trend: "Needs attention", accent: "text-rose-600" },
  { label: "Monthly Profit",      value: "$18,450",   trend: "↑ 15.3%", accent: "text-emerald-600" },
];
